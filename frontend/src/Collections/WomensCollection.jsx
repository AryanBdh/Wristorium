...
import { Search, Filter, Heart, ShoppingBag, Grid, List, Sparkles } from "lucide-react"
...
const WomensCollection = () => {
  ...
  const subCategories = [...new Set(womensWatches.map((watch) => watch.collection))].filter(Boolean)

  // Filter and search logic
  const filteredWatches = useMemo(() => {
    const filtered = womensWatches.filter((watch) => {
      const matchesSearch =
    ...
    return filtered
  }, [searchTerm, selectedSubCategory, priceRange, sortBy, womensWatches])
  ...
  const maxPrice = Math.max(...womensWatches.map((watch) => watch.price))
            ...
            <div className="text-center max-w-4xl px-4">
              ...
              <div className="flex items-center justify-center gap-8 text-sm text-gray-300">
                <div className="flex items-center gap-2">
                  ...
                  <span>{womensWatches.length} Watches</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-[#d4af37] rounded-full"></div>
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center justify-between text-sm text-gray-400">
              <span>
                ...
                {filteredWatches.length} women's watches
              </span>
