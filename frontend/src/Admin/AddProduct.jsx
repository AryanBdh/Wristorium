...
import { Upload, X, Plus, Minus, Save, ArrowLeft, AlertCircle, CheckCircle } from "lucide-react"
...
const AddProduct = () => {
    ...
    switch (field) {
      ...
      case "originalPrice":
        if (value && value.trim()) {
          ...
          if (isNaN(originalPrice) || originalPrice <= 0) return "Original price must be a positive number"
          if (originalPrice <= currentPrice) return "Original price must be higher than current price"
          if (originalPrice > 1000000) return "Original price must be less than $1,000,000"
        }
        return ""
      ...
      case "sku":
        if (value && value.trim()) {
          if (value.trim().length < 3) return "SKU must be at least 3 characters"
      ...
      case "features":
        ...
        if (validFeatures.length === 0) return "At least one feature is required"
        if (validFeatures.some((f) => f.trim().length > 100)) return "Each feature must be less than 100 characters"
        return ""
  ...
  const validateNestedField = (section, field, value) => {
    if (value && value.trim()) {
      if (field === "diameter" || field === "thickness" || field === "lugWidth") {
  ...
  const validateForm = () => {
    ...
    const basicFields = ["name", "description", "price", "originalPrice", "stock", "sku", "weight"]
    ...
    // Validate images
    const imagesError = validateField("images", imageFiles)
    if (imagesError) newErrors.images = imagesError

    // Validate nested fields
    Object.keys(productData.dimensions).forEach((field) => {
      const error = validateNestedField("dimensions", field, productData.dimensions[field])
  ...
  const handleNestedBlur = (section, field) => {
    ...
    const error = validateNestedField(section, field, productData[section][field])
    setErrors((prev) => ({ ...prev, [fieldKey]: error }))
  }
  ...
  const handleImageUpload = (files) => {
    ...
    // Validate images
    const error = validateField("images", [...imageFiles, ...newFiles])
  ...
  const removeImage = (index) => {
    ...
    if (touched.images) {
      ...
      const error = validateField("images", updatedFiles)
      setErrors((prev) => ({ ...prev, images: error }))
    }
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("isNewProduct", productData.isNewProduct)
      ...
      formData.append(
        ...
        JSON.stringify({
          ...
          functions: productData.specifications.functions.filter((f) => f.trim()),
        }),
      )
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Create a new timepiece for WHRISTORIUM</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="max-w-7xl mx-auto space-y-8" noValidate>
            ...
            <div className="bg-[#0f1420] rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <Input
                      ...
                      aria-describedby={errors.sku && touched.sku ? "sku-error" : undefined}
                    />
                  ...
                  {errors.sku && touched.sku && (
                    <p id="sku-error" className="mt-1 text-sm text-red-400 flex items-center gap-1">
                      <AlertCircle className="h-3 w-3" />
                      {errors.sku}
                    </p>
                  )}
                ...
                <div>
                  ...
                  {errors.price && touched.price && (
                    <p id="price-error" className="mt-1 text-sm text-red-400 flex items-center gap-1">
                      <AlertCircle className="h-3 w-3" />
                      {errors.price}
                    </p>
                  )}
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">Original Price (if on sale)</label>
                  <div className="relative">
                    <Input
                      name="originalPrice"
                      type="number"
                      ...
                      aria-invalid={errors.originalPrice && touched.originalPrice ? "true" : "false"}
                      aria-describedby={
                        errors.originalPrice && touched.originalPrice ? "originalPrice-error" : undefined
                      }
                    />
                    {!errors.originalPrice && touched.originalPrice && productData.originalPrice && (
                      <CheckCircle className="absolute right-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-green-500" />
                    )}
                  ...
                  {errors.originalPrice && touched.originalPrice && (
                    <p id="originalPrice-error" className="mt-1 text-sm text-red-400 flex items-center gap-1">
                      <AlertCircle className="h-3 w-3" />
                ...
                <div>
                  ...
                  <div className="relative">
                    <Input
                      ...
                      aria-describedby={errors.stock && touched.stock ? "stock-error" : undefined}
                    />
                  ...
                  {errors.stock && touched.stock && (
                    <p id="stock-error" className="mt-1 text-sm text-red-400 flex items-center gap-1">
                      <AlertCircle className="h-3 w-3" />
                      {errors.stock}
                    </p>
                  )}
                ...
                <div>
                  ...
                  {errors.weight && touched.weight && (
                    <p id="weight-error" className="mt-1 text-sm text-red-400 flex items-center gap-1">
                      <AlertCircle className="h-3 w-3" />
                      {errors.weight}
                    </p>
                  )}
                  ...
                  <textarea
                    ...
                    className={`w-full bg-[#1a1f2c] border border-gray-700 rounded px-3 py-2 resize-none ${
                      errors.description && touched.description
                        ...
                        : !errors.description && touched.description && productData.description
            ...
            <div className="bg-[#0f1420] rounded-lg p-6">
              ...
              >
                ...
                <p className="text-sm text-gray-400 mb-4">or click to browse (Max 6 images)</p>
                <input
                  type="file"
                  multiple
                  accept="image/*"
                  ...
                  onBlur={() => {
                    setTouched((prev) => ({ ...prev, images: true }))
                    const error = validateField("images", imageFiles)
                    setErrors((prev) => ({ ...prev, images: error }))
                  }}
                  className="hidden"
                  id="image-upload"
                    ...
                    <div className="flex-1 relative">
                      <Input
                        ...
                        onBlur={() => {
                          ...
                          const error = validateField("features", productData.features)
                          setErrors((prev) => ({ ...prev, features: error }))
                        }}
                        placeholder="e.g., Automatic Movement"
                        className={errors.features && touched.features ? "border-red-500" : ""}
                      />
                    </div>
            ...
            <div className="bg-[#0f1420] rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <label className="block text-sm font-medium mb-2">Case Diameter (mm)</label>
                  <div className="relative">
                    <Input
                      ...
                      onChange={(e) => handleNestedInputChange("dimensions", "diameter", e.target.value)}
                      onBlur={() => handleNestedBlur("dimensions", "diameter")}
                      placeholder="42"
                      className={getNestedFieldClassName("dimensions", "diameter")}
                      aria-invalid={errors["dimensions.diameter"] && touched["dimensions.diameter"] ? "true" : "false"}
                      aria-describedby={
                        errors["dimensions.diameter"] && touched["dimensions.diameter"] ? "diameter-error" : undefined
                      }
                    />
                    ...
                    {errors["dimensions.diameter"] && touched["dimensions.diameter"] && (
                      <AlertCircle className="absolute right-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-red-500" />
                    )}
                  </div>
                  {errors["dimensions.diameter"] && touched["dimensions.diameter"] && (
                    <p id="diameter-error" className="mt-1 text-sm text-red-400 flex items-center gap-1">
                      <AlertCircle className="h-3 w-3" />
                      {errors["dimensions.diameter"]}
                    </p>
                  )}
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">Case Thickness (mm)</label>
                  <div className="relative">
                    <Input
                      ...
                      onChange={(e) => handleNestedInputChange("dimensions", "thickness", e.target.value)}
                      onBlur={() => handleNestedBlur("dimensions", "thickness")}
                      placeholder="12"
                      className={getNestedFieldClassName("dimensions", "thickness")}
                      aria-invalid={
                        errors["dimensions.thickness"] && touched["dimensions.thickness"] ? "true" : "false"
                      }
                      aria-describedby={
                        errors["dimensions.thickness"] && touched["dimensions.thickness"]
                          ? "thickness-error"
                          : undefined
                      }
                    />
                  ...
                  {errors["dimensions.thickness"] && touched["dimensions.thickness"] && (
                    <p id="thickness-error" className="mt-1 text-sm text-red-400 flex items-center gap-1">
                      <AlertCircle className="h-3 w-3" />
                      {errors["dimensions.thickness"]}
                    </p>
                  )}
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">Lug Width (mm)</label>
                  <div className="relative">
                    <Input
                      ...
                      onChange={(e) => handleNestedInputChange("dimensions", "lugWidth", e.target.value)}
                      onBlur={() => handleNestedBlur("dimensions", "lugWidth")}
                      placeholder="22"
                      className={getNestedFieldClassName("dimensions", "lugWidth")}
                      aria-invalid={errors["dimensions.lugWidth"] && touched["dimensions.lugWidth"] ? "true" : "false"}
                      aria-describedby={
                        errors["dimensions.lugWidth"] && touched["dimensions.lugWidth"] ? "lugWidth-error" : undefined
                      }
                    />
                    ...
                    {errors["dimensions.lugWidth"] && touched["dimensions.lugWidth"] && (
                      <AlertCircle className="absolute right-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-red-500" />
                    )}
                  </div>
                  {errors["dimensions.lugWidth"] && touched["dimensions.lugWidth"] && (
                    <p id="lugWidth-error" className="mt-1 text-sm text-red-400 flex items-center gap-1">
                      <AlertCircle className="h-3 w-3" />
                      {errors["dimensions.lugWidth"]}
                    </p>
                  )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleNestedInputChange("materials", "case", e.target.value)}
                    placeholder="316L Stainless Steel"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2">Crystal</label>
                  <Input
                    value={productData.materials.crystal}
                    onChange={(e) => handleNestedInputChange("materials", "crystal", e.target.value)}
                    placeholder="Sapphire Crystal"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2">Strap Material</label>
                  <Input
                    value={productData.materials.strap}
                    onChange={(e) => handleNestedInputChange("materials", "strap", e.target.value)}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleNestedInputChange("materials", "movement", e.target.value)}
            ...
            <div className="bg-[#0f1420] rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleNestedInputChange("specifications", "waterResistance", e.target.value)}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleNestedInputChange("specifications", "powerReserve", e.target.value)}
              ...
              <div>
                <label className="block text-sm font-medium mb-3">Functions</label>
                <div className="space-y-3">
                  {productData.specifications.functions.map((func, index) => (
                    <div key={index} className="flex gap-3">
                      <Input
                        value={func}
                        onChange={(e) => {
                          const newFunctions = [...productData.specifications.functions]
                          newFunctions[index] = e.target.value
                          handleNestedInputChange("specifications", "functions", newFunctions)
                        }}
                      ...
                      {productData.specifications.functions.length > 1 && (
                        <Button
                          type="button"
                          onClick={() => {
                            const newFunctions = productData.specifications.functions.filter((_, i) => i !== index)
                            handleNestedInputChange("specifications", "functions", newFunctions)
                          }}
                          variant="outline"
                          size="sm"
